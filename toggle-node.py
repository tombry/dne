...
def main():
    ...
    r = get_node_status(args.virl_host, args.virl_user, args.virl_pwd, args.sim_name, args.node_name)
    p = r.json()
    pprint.pprint(p) 
    exit(0)
...
def get_node_status(virl_host, virl_user, virl_pwd, sim_name, node_name):
